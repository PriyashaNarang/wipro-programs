#MINI PROJECT
"""Q1. Through command line arguments three strings separated by space are given to you. Each string is a series of numbers separated by hyphen(-). You like all the numbers in string 1 and dislike all the numbers in string 2.
...
Sample input 2:
60-77-34-5-2 44-11-99-3 77-15-13-12-2-34-3
Sample output 2:
2
Explanation:
...
string1=argv[1]
likenumbers=string1.split("-")
string2=argv[2]
dislikenumbers=string2.split("-")
string3=argv[3]
reqnumbers=string3.split("-")
happy=0
for i in reqnumbers:
    if i in likenumbers:
        happy+=1
    elif i in dislikenumbers:
        happy-=1
print(happy)